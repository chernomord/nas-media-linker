...
const UX_STATE_DB_PATH = env(
  "UX_STATE_DB_PATH",
  path.join(path.dirname(fileURLToPath(import.meta.url)), "data", "ux-state.sqlite"),
);
...
const UI_TEMPLATE = fs.readFileSync(new URL("./ui.html", import.meta.url), "utf8");
const LOGIN_TEMPLATE = fs.readFileSync(new URL("./login.html", import.meta.url), "utf8");
