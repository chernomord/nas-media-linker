...
## Historical note
Historical roadmap sections below may mention the retired SSH/bash rollback path. Those references are preserved only as project history and are no longer part of the current runtime model.
