...
Линковка сезона нормализует имена эпизодов в непрерывную последовательность `SxxEyy` внутри целевой папки сезона, чтобы последующие release blocks могли дописываться без коллизий на `01..N` в исходных именах.
